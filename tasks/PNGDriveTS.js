...
(function (_pngdrive) {
    ...
    var PNGDriveBitStream = (function () {
        function PNGDriveBitStream(uint8array) {
            this.a = uint8array;
            this.position = 0;
            this.bitsPending = 0;
        }
        PNGDriveBitStream.prototype.writeBits = function (bits, value) {
            if (bits == 0) {
                return;
            }
        ...
        PNGDriveBitStream.prototype.readBits = function (bits, bitBuffer) {
        ...
        PNGDriveBitStream.prototype.seekTo = function (bitPos) {
        ...
        return PNGDriveBitStream;
    })();
    _pngdrive.PNGDriveBitStream = PNGDriveBitStream;

    var PNGDrive = (function () {
        function PNGDrive(image, bitsPerColorComponent) {
        ...
        PNGDrive.prototype.addFile = function (file) {
            this.files.push({ name: file.name, type: file.type, fileRef: file });
            return this;
        };

        PNGDrive.prototype.addTextFile = function (text, name, type) {
            this.files.push({ name: name, type: type, content: this.utf8Encode(text) });
            return this;
        };

        PNGDrive.prototype.addBinaryFile = function (uint8Array, name, type) {
            this.files.push({ name: name, type: type, content: uint8Array });
            return this;
        };

        PNGDrive.prototype.removeAll = function () {
            this.files = [];
            return this;
        };

        PNGDrive.prototype.removeFileAt = function (index) {
        ...
        PNGDrive.prototype.removeFileByName = function (name) {
        ...
        PNGDrive.prototype.getFileCount = function () {
            return this.files.length;
        };

        PNGDrive.prototype.getFileAt = function (index) {
            return (index >= 0 && index < this.files.length) ? this.files[index] : null;
        };

        PNGDrive.prototype.getFileByName = function (name) {
            for (var i = 0; i < this.files.length; i++) {
                if (this.files[i].name == name) {
                    return this.files[i];
                }
        ...
        PNGDrive.prototype.decode = function (image, bitsPerColorComponent) {
        ...
        PNGDrive.prototype.encode = function (callback) {
            var that = this;
            (function (serialize) {
        ...
        PNGDrive.prototype.createImage = function (targetImage, bitsPerColorComponent) {
            var canvas = this.createCanvas();
            var ctx = canvas.getContext('2d');
            if (typeof targetImage == "undefined") {
                ...
                if (typeof bitsPerColorComponent == "undefined") {
                    bitsPerColorComponent = 8;
                }
        ...
        PNGDrive.prototype.computeImageCapacity = function (targetImage, bitsPerColorComponent) {
            if (typeof bitsPerColorComponent === "undefined") { bitsPerColorComponent = 8; }
            var canvas = this.createCanvas();
            var ctx = canvas.getContext('2d');
            canvas.width = targetImage.width;
        ...
        PNGDrive.prototype.utf8Encode = function (string) {
            string += '';
            var tmparr = [];
        ...
        // http://stackoverflow.com/questions/246801/how-can-you-encode-to-base64-using-javascript/6836708
        // (modified to use typed arrays)
        PNGDrive.prototype.utf8Decode = function (uint8array) {
        ...
        PNGDrive.prototype.createCanvas = function () {
            if (typeof window === 'undefined') {
                return new Canvas();
            } else {
    ...
    _pngdrive.PNGDrive = PNGDrive;
})(exports.pngdrive || (exports.pngdrive = {}));
var pngdrive = exports.pngdrive;
